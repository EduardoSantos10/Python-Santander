...
arquivo = open("dados.txt", "r") # Estou utilizando o modo "open()" para abrir o arquivo

conteudo = arquivo.read() # Método "read()" para ler arquivos

print(conteudo) # Imprimo o que está dentro do arquivo

arquivo.close() # Fecho meu arquivo com a função "close()"
